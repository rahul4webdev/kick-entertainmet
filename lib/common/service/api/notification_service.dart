...
class NotificationService {
  ...
  Future<List<ActivityNotification>> fetchNotificationsByCategory(
      {required String category, int? lastItemId}) async {
    ActivityNotificationModel response = await ApiService.instance.call(
        url: WebService.notification.fetchNotificationsByCategory,
        fromJson: ActivityNotificationModel.fromJson,
        param: {
          Params.limit: AppRes.paginationLimit,
          Params.lastItemId: lastItemId,
  ...
  Future<StatusModel> markNotificationsAsRead(
      {required List<int> notificationIds}) async {
    return await ApiService.instance.call(
        url: WebService.notification.markNotificationsAsRead,
        fromJson: StatusModel.fromJson,
        param: {'notification_ids': notificationIds});
  }

  Future<StatusModel> markAllNotificationsAsRead({String? category}) async {
    return await ApiService.instance.call(
        url: WebService.notification.markAllNotificationsAsRead,
        fromJson: StatusModel.fromJson,
        param: {if (category != null) 'category': category});
  }

  Future<UnreadNotificationCount> fetchUnreadNotificationCount() async {
    return await ApiService.instance.call(
        url: WebService.notification.fetchUnreadNotificationCount,
        fromJson: UnreadNotificationCount.fromJson,
        param: {});
  }
