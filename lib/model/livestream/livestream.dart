...
class Livestream {
  ...
  Livestream.fromJson(Map<String, dynamic> json) {
    ...
    hostId = json['host_id'];
    coHostIds = ((json['co_host_ids'] ?? json['co-host_ids']) as List?)?.cast<int>() ?? [];
    ...
    giftGoalTarget = json['gift_goal_target'];
    giftGoalCurrent = json['gift_goal_current'];
    giftGoalLabel = json['gift_goal_label'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['gift_goal_target'] = giftGoalTarget;
    data['gift_goal_current'] = giftGoalCurrent;
    data['gift_goal_label'] = giftGoalLabel;
    return data;
  }
