...
class Hashtag {
  ...
  Hashtag.fromJson(dynamic json) {
    ...
    _postCount = json['post_count'] is bool ? (json['post_count'] == true ? 1 : 0) : json['post_count'];
    _onExplore = json['on_explore'] is bool ? (json['on_explore'] == true ? 1 : 0) : json['on_explore'];
