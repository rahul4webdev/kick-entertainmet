...
class Comment {
  ...
  Comment.fromJson(dynamic json) {
    ...
    isCreatorLiked = json['is_creator_liked'] == true || json['is_creator_liked'] == 1;
    score = json['score'];
    type = json['type'] == null
        ? CommentType.text
        : CommentType.values
    ...
    videoReplyCount = json['video_reply_count'];
  ...
  Map<String, dynamic> toJson() {
    ...
    map['is_creator_liked'] = isCreatorLiked;
    map['score'] = score;
    map['type'] = type.value;
    map['created_at'] = createdAt;
    map['updated_at'] = updatedAt;
    map['is_liked'] = isLiked;
    map['video_reply_count'] = videoReplyCount;
