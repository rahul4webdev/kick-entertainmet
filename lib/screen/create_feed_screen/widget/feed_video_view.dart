  ...
  Widget build(BuildContext context) {
    return Obx(
      () {
        ...
        final isInitialized = playerController.value.isInitialized;
        double width = isInitialized ? playerController.value.size.width : Get.width;
        double height = isInitialized ? playerController.value.size.height : Get.width;
        final filter = video.colorFilter.length == 20
            ? video.colorFilter
            : defaultFilter;
