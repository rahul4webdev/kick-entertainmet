                                ...
                                child: Wrap(
                                  ...
                                  children: List.generate(
                                    ...
                                    (index) {
                                      ...
                                      return Obx(() {
                                        AppUser? chatUser = chatConversation.chatUserRx.value;
                      ...
                      child: Row(
                        children: [
                          ...
                          PlatformShareButton(
                            ...
                            onTap: () => controller.onShareSheetBottomBtnTap(ShareOption.facebook, link, post: post),
                          ),
                          const SizedBox(width: 12),
                          PlatformShareButton(
                            icon: Icons.close,
                            label: 'X',
                            color: Colors.black,
                            onTap: () => controller.onShareSheetBottomBtnTap(ShareOption.twitter, link, post: post),
                          ),
                          const SizedBox(width: 12),
                          CustomAssetWithBgButton(
  ...
  String value(String link) {
    switch (this) {
      ...
      case ShareOption.twitter:
        return "https://twitter.com/intent/tweet?url=${Uri.encodeComponent(link)}";
