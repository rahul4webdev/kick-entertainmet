...
class TextEditorSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    controller
      ...
      ..selectedTextAnimation.value = data.textAnimation;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        // Text animation picker
        Padding(
          padding: const EdgeInsets.only(bottom: 8),
          child: Obx(() => TextAnimationPicker(
                selected: controller.selectedTextAnimation.value,
                onChanged: (anim) =>
                    controller.selectedTextAnimation.value = anim,
              )),
        ),
        Container(
          decoration: ShapeDecoration(
