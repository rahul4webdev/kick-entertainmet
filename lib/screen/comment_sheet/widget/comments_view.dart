    ...
    return Obx(
      () => GestureDetector(
        ...
        child: LoadMoreWidget(
          loadMore: controller.sortMode.value == 'top'
              ? controller.fetchTopComments
              : controller.fetchComments,
          child: ListView.builder(
            itemCount: controller.getActiveCommentsList.length,
            primary: false,
            shrinkWrap: true,
            padding: const EdgeInsets.symmetric(vertical: 5),
            itemBuilder: (context, index) {
              Comment comment = controller.getActiveCommentsList[index];
              bool isNotify = false;
