...
import 'package:shortzz/screen/live_stream/scheduled_live_screen/scheduled_live_screen.dart';
      ...
      child: Stack(
        ...
        children: [
          Align(
            ...
            child: InkWell(
              onTap: () => Get.to(() => const ScheduledLiveScreen()),
              child: Container(
                height: 30,
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.schedule, color: whitePure(context), size: 18),
                    const SizedBox(width: 4),
                    Text(
                      LKey.upcoming,
                      style: TextStyleCustom.unboundedRegular400(color: whitePure(context), fontSize: 11),
                    ),
                  ],
                ),
              ),
