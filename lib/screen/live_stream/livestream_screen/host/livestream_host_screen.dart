...
import 'package:shortzz/screen/live_stream/livestream_screen/widget/gift_goal_bar.dart';
import 'package:shortzz/screen/live_stream/livestream_screen/widget/live_poll_overlay.dart';
import 'package:shortzz/screen/live_stream/livestream_screen/widget/live_flash_sale_overlay.dart';
      ...
      body: PopScope(
        ...
        child: Stack(
          children: [
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      GiftGoalBar(controller: controller),
                      LivePollOverlay(controller: controller),
                    ],
                  ),
            ...
            // Shopping tool overlays
            LiveFlashSaleOverlay(controller: controller),
            LiveGiveawayOverlay(controller: controller),
            LivePromoBannerOverlay(controller: controller),
