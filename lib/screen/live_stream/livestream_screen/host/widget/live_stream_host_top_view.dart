...
import 'package:shortzz/screen/live_stream/livestream_screen/widget/create_poll_sheet.dart';
...
import 'package:shortzz/screen/live_stream/livestream_screen/widget/set_gift_goal_sheet.dart';
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        LiveStreamCircleBorderButton(
                            ...
                            onTap: () {
                              Get.bottomSheet(
                                SetGiftGoalSheet(controller: controller),
                                isScrollControlled: true,
                              );
                            },
                          ),
                        InkWell(
                          onTap: () {
                            Get.bottomSheet(
                              CreatePollSheet(controller: controller),
                              isScrollControlled: true,
                            );
                          },
                          child: Container(
                            ...
                            child: Icon(Icons.poll, size: 16, color: Colors.amber),
                          ),
                        ),
                        InkWell(
                          onTap: () {
                          ...
                          child: Container(
                            ...
                            child: Icon(Icons.question_answer, size: 16, color: whitePure(context)),
                          ),
                        ),
