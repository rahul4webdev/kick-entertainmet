...
import 'package:shortzz/screen/drafts_screen/drafts_screen.dart';
import 'package:shortzz/screen/playlist_screen/profile_playlists_tab.dart';
import 'package:shortzz/screen/profile_screen/profile_screen_controller.dart';
import 'package:shortzz/screen/profile_screen/widget/profile_qna_tab.dart';
              ...
              : user?.isFreez == 1
                  ...
                  : PageView(
                      ...
                      children: [
                        ...
                        ProfileQnATab(
                          profileUserId: user?.id?.toInt() ?? 0,
                          isMe: isMe,
                        ),
                        if (controller.hasExclusiveTab)
                          PostList(
                            posts: controller.exclusivePosts,
                            onFetchMoreData: controller.fetchExclusivePosts,
                            isLoading: controller.isExclusiveLoading,
                            shouldShowPinOption: false,
                            isMe: isMe,
                          ),
                        if (isMe) const DraftsScreen(),
                      ],
                    );
    }));
  }
