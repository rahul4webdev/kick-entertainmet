...
import 'package:shortzz/common/widget/poll_card_widget.dart';
import 'package:shortzz/common/widget/quoted_post_card.dart';
import 'package:shortzz/screen/reels_screen/reels_screen.dart';
import 'package:shortzz/screen/thread_screen/thread_screen.dart';
        ...
        children: [
          ...
          if (post.poll != null)
            Padding(
              ...
              child: PollCardWidget(poll: post.poll!, postId: post.id),
            ),
          if (post.isQuoteRepost && post.quotedPost != null)
            QuotedPostCard(quotedPost: post.quotedPost!),
          if (post.isThread && (post.threadCount ?? 0) > 1)
            Padding(
              padding: const EdgeInsets.only(top: 6, right: 10),
              child: InkWell(
                onTap: () {
                  Get.to(() => ThreadScreen(
                      threadId: post.threadId!, initialPost: post));
                },
                child: Row(
                  children: [
                    Icon(Icons.segment,
